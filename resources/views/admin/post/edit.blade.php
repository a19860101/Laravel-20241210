        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div><small>文章更新時間:{{$post->updated_at}}</small></div>
                    <div class="flex gap-4">
                        <div class="w-1/2">
                            <form action="{{route('post.update',$post->id)}}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select type="text" name="category_id" class="p-2 border border-zinc-300 rounded-lg w-full">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="body" class="p-2 border border-zinc-300 rounded-lg w-full">{{$post->body}}</textarea>
                                </div>
                        ...
                        <div class="w-1/2">
                            <img src="{{asset('storage/'.$post->cover)}}" alt="" class="w-full">
                        </div>
                    </div>
                </div>
            </div>
